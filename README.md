...
# Developing
Native apps live in [`swiftui/`](swiftui/README.md) for macOS/iOS and [`android/`](android/README.md) for Android. The Android app targets Android 16, supports Android 8.0 and newer, and uses Kotlin and Jetpack Compose. Both native apps support only journal format 7.0.
