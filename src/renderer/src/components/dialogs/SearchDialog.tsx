...
export function SearchDialog() {
    const { activeDialog, closeDialog, journalData, selectEntry } =
        useJournalStore();
    ...
    const handleSearch = () => {
        ...
        if (sentiment !== "all") {
            filtered = filtered.filter(
                (entry) => entry.sentiment === sentiment,
            );
        }
    ...
    const handleSelectEntry = (entry: any) => {
        const index = journalData!.entries.findIndex((e) => e === entry);
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="max-w-3xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Filter your journal entries by text, sentiment, or
                        attachments.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Select
                                value={sentiment}
                                onValueChange={(val) =>
                                    setSentiment(val as Sentiment | "all")
                                }
                            >
